<?		
mysql_connect("localhost", "admin_pkmo", "swU5E7epREY8weWre");
mysql_select_db('admin_pkmo'); 
...
if(isset($_POST['verstuur'])){
    ...
    if(empty($bericht)) {
      echo '<div class="red">No text entered.</div>';
    }
    //Als alles is ingevuld het bericht versturen
    else{
      $speler = mysql_query("SELECT `username`, `email` FROM `gebruikers` WHERE domass='1'"); #between '1900' and '4000'
      $aantal = 0;
...
<div align="center">
  <table width="70%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="11" rowspan="2" background="images/mail/linksbalk.gif"></td>
      <td align="center" bgcolor="#D3E9F5"><img src="images/mail/headermail.png" width="520" height="140"></td>
      <td width="11" rowspan="2" background="images/mail/rechtsbalk.gif"></td>
    </tr>
    <tr>
  ...
  &copy; '.GLOBALDEF_SITENAME.' - '.date('Y').'<br>
        ...
        echo '<div class="green">Mass Mail successful '.$aantal.'x sent!</div>'; 
  }
